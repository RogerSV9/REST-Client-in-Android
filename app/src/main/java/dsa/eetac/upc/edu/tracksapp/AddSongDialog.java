...
public class AddSongDialog extends DialogFragment {
    ...
    AddSongDialog.IAddSongDialogListener listener;

    public interface IAddSongDialogListener {
        void onDialogAddPositiveClick(String id, String name, String singer);
    }

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        if (getActivity() instanceof AddSongDialog.IAddSongDialogListener) {
            listener = (AddSongDialog.IAddSongDialogListener) getActivity();
        }
    }
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (listener != null) {
                            listener.onDialogAddPositiveClick(idEditText.getText().toString(), nameEditText.getText().toString(), singerEditText.getText().toString());
                        }
                    }
                });
